 ...
 * @author Daniel
 */
public class entornoProfesor3 extends javax.swing.JFrame {
     ...
     */
    public entornoProfesor3() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        txtDescripcion.setLineWrap(true);
        setTitle("Entorno Docente --- Santiago Quiñones ---");
    ...
    private void menuEditarInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditarInformacionActionPerformed
        ...
        try {
            Process process = runtime.exec("C:\\Windows\\notepad.exe C:\\Users\\Daniel\\OneDrive\\Proyecto\\Info\\SantiagoQuiñones.txt");
        } catch (IOException ex) {
            Logger.getLogger(entornoProfesor3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(entornoProfesor3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new entornoProfesor3().setVisible(true);
        });
    }
