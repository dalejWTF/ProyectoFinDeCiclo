 ...
 * @author Daniel
 */
public class entornoProfesor4 extends javax.swing.JFrame {
     ...
     */
    public entornoProfesor4() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        txtDescripcion.setLineWrap(true);
        setTitle("Entorno Docente --- Cadme Samaniego ---");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnRespuesta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void menuEditarInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditarInformacionActionPerformed
        ...
        try {
            Process process = runtime.exec("C:\\Windows\\notepad.exe C:\\Users\\Daniel\\OneDrive\\Proyecto\\Info\\CadmeSamaniego.txt");
        } catch (IOException ex) {
            Logger.getLogger(entornoProfesor4.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(entornoProfesor4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new entornoProfesor4().setVisible(true);
        });
    }
