...
public class entornoProfesorr {
    ...
    private JTextArea aprobacion;    

    //Constructor de clase
    public entornoProfesorr(){this.filter = new FileNameExtensionFilter("Archivo de Texto","txt");
}

    public entornoProfesorr(JTextField numero, JTextField nombre, JTextArea aprobacion )
    {
        this.filter = new FileNameExtensionFilter("Archivo de Texto","txt");
        this.numero= numero;
        this.nombre = nombre;
    ...
    {       
       ...
       if ( result == JFileChooser.APPROVE_OPTION ){
                ...
                {
                    JOptionPane.showMessageDialog(null, "Respuesta Enviada Exitosamente!", "Registro",JOptionPane.INFORMATION_MESSAGE);
                    this.isopen=true;
                }
        }
    }
    ...
    public void Abrir()
    {
     fileChooser = new JFileChooser();
       ...
       if ( result == JFileChooser.APPROVE_OPTION ){
                ...
                leer( this.file );
                this.isopen=true;
                aprobaciones.dirArchivo= file.getAbsolutePath();
        }
    }
    ...
    public void Siguiente()
    {
        ...
        while (It.hasNext())
        {
            ...
            {   //separa el registro por campos. Separador = ","
                ...
                this.numero.setText(datos[0]);
                this.nombre.setText(datos[1]);
                this.aprobacion.setText(datos[2]); 
                break;
            }
            count ++;
        }
